...
<Project Type="Project" LVVersion="15008000">
	<Item Name="マイ コンピュータ" Type="My Computer">
		...
		<Item Name="依存項目" Type="Dependencies">
			<Item Name="LC-MISDK.dll" Type="Document" URL="../LC-MISDK.dll"/>
			...
			<Item Name="LC-MISDK_UserCalibration_MakeListData_LvλdPe.vi" Type="VI" URL="../LC-MISDK_UserCalibration_MakeListData_LvλdPe.vi"/>
